...
object Objects {
  ...
  // 2 - equality of "sameness" - in Java defined as .equals (same data)
  ...
  // Scala application = object that is a singleton instance + a main method 'def main(args: Array[String]): Unit'
  /*
